...
class smsClassAction extends Action
{
	...
	public function gettotalAjax()
	{
		...
		$barr['sms_bnum'] = $this->option->getval('sms_bnum');
		$barr['sms_bpwd'] = $this->option->getval('sms_bpwd');
		return $barr;
	}
	...
	public function cogsaveAjax()
	{
		...
		$this->option->setval('sms_bnum', $this->post('sms_bnum'));//赛邮云短信账号
		$this->option->setval('sms_bpwd', $this->post('sms_bpwd'));//赛邮云短信密码
